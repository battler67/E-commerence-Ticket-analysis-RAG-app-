...
- **Citation Coverage Rate**: 15.0% (Target 100% for tickets that proceed to resolution).
...
## Full Example Runs
\n### 1. Exception handled correctly (T010)\n- **Issue Type**: Refund\n- **Decision**: needs_clarification\n- **Clarifying Questions**: ['What size did you order for the jacket?', 'What outcome are you seeking regarding the jacket?', 'Is there a specific reason you believe a return or exchange is warranted despite the final sale policy?']\n- **Rationale**: N/A\n- **Drafted Response**: N/A\n- **Citations Used**:\n\n### 2. Conflict handled with escalation (T017)\n- **Issue Type**: Refund\n- **Decision**: needs_clarification\n- **Clarifying Questions**: ['What specific issue are you experiencing with the blender?', 'Have you attempted to contact the seller through any specific channels?', 'When did you first try to reach out to the seller?']\n- **Rationale**: N/A\n- **Drafted Response**: N/A\n- **Citations Used**:\n\n### 3. Correct abstention / need more info (T020)\n- **Issue Type**: Refund\n- **Decision**: needs_clarification\n- **Clarifying Questions**: ['What item are you requesting a refund for?', 'What is the reason for the refund request?', 'Have you already initiated a return process for the item?']\n- **Rationale**: N/A\n- **Drafted Response**: N/A\n- **Citations Used**:\n